...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      field_mappings: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "field_mappings_upload_id_fkey"
            columns: ["upload_id"]
            isOneToOne: false
      ...
      foia_updates: {
        ...
        Relationships: [
          {
            foreignKeyName: "foia_updates_import_session_id_fkey"
            columns: ["import_session_id"]
            isOneToOne: false
            referencedRelation: "foia_import_sessions"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "foia_updates_parcel_id_fkey"
            columns: ["parcel_id"]
            isOneToOne: false
      ...
      parcels: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "parcels_state_id_fkey"
            columns: ["state_id"]
            isOneToOne: false
            referencedRelation: "states"
            referencedColumns: ["id"]
      ...
      salesforce_sync: {
        ...
        Relationships: [
          {
            foreignKeyName: "salesforce_sync_parcel_id_fkey"
            columns: ["parcel_id"]
            isOneToOne: false
            referencedRelation: "parcels"
            referencedColumns: ["id"]
      ...
      user_assignments: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_assignments_assigned_by_fkey"
            columns: ["assigned_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "user_assignments_parcel_id_fkey"
            columns: ["parcel_id"]
            isOneToOne: false
            referencedRelation: "parcels"
            referencedColumns: ["id"]
      ...
      user_queues: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_queues_parcel_id_fkey"
            columns: ["parcel_id"]
            isOneToOne: false
            referencedRelation: "parcels"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      search_properties: {
        Args: {
          search_state_code?: string
          search_county_name?: string
          search_city_name?: string
          zoning_filter?: string
          occupancy_filter?: string
          sprinklers_filter?: boolean
          limit_count?: number
        }
        Returns: {
          id: string
